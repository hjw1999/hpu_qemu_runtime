...
static const struct MemmapEntry
{
    ...
    [SIFIVE_E_AMO]      = {0x2010000, 0x40},
    [SIFIVE_E_MMAB]     = {0x2100000, 0x80000},
#endif
    ...
    [SIFIVE_E_DTIM]     = {0x80000000, 0x80000000},  // 64MB
};
...
static void riscv_sifive_e_init(MachineState *machine)
{
    ...
    uint32_t reset_vec[2] = {
        ...
        0x840002b7, /* 0x1000: lui     t0,0x84000 */ // edit for hipu runtime
...
#ifdef CONFIG_HIPUISA
    MemoryRegion *amo_mem = g_new(MemoryRegion, 1);
    memory_region_init_ram(amo_mem, NULL, "riscv.sifive.e.amo",
                            memmap[SIFIVE_E_AMO].size, &error_fatal);
    memory_region_add_subregion(sys_mem, memmap[SIFIVE_E_AMO].base, amo_mem);
    hipu_mmab_create(memmap[SIFIVE_E_MMAB].base, memmap[SIFIVE_E_MMAB].size);
#endif
}
