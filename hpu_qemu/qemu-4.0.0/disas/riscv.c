...
static const char *csr_name(int csrno)
{
    ...
    case 0x0386: return "shift_num";
    case 0x0387: return "round_type";
    case 0x0388: return "acc_blk_size";
    case 0x0389: return "acc_blk_stride";
    case 0x038a: return "acc_blk_num";
