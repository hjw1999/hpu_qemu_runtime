...
static int disas_xx_insn(DisasContext *s, uint32_t insn)
{
    if(insn == 0xdeadbeef){
        // printf("disas_xx_insn\n");
        // gen_helper_trace_dead(cpu_env);
        gen_helper_trace_ldst(cpu_env);
        return 1;
    }
    return 0;
}
