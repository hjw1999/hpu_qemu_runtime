...
DEF_HELPER_1(trace_insn, void, tl)
DEF_HELPER_0(hipu_insn, void)
DEF_HELPER_1(check_pc, void, env)
DEF_HELPER_4(hipu_ldvr, void, env, tl, tl, tl)
DEF_HELPER_4(hipu_stvr, void, env, tl, tl, tl)
DEF_HELPER_6(hipu_va, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_6(hipu_vai, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_5(hipu_valh, void, env, tl, tl, tl, tl)
DEF_HELPER_5(hipu_valv, void, env, tl, tl, tl, tl)
DEF_HELPER_5(hipu_vp, void, env, tl, tl, tl, tl)
DEF_HELPER_5(hipu_vpi, void, env, tl, tl, tl, tl)
DEF_HELPER_5(hipu_vpp, void, env, tl, tl, tl, tl)
DEF_HELPER_3(hipu_vpswap, void, env, tl, tl)
DEF_HELPER_6(hipu_vf, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_6(hipu_vfi, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_6(hipu_matrix_op, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_6(hipu_matrix_op_sh, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_5(hipu_vlut, void, env, tl, tl, tl, tl)
DEF_HELPER_1(print_mmab, void, env)
DEF_HELPER_1(print_mem, void, env)
DEF_HELPER_4(sort, void, env, tl, tl, tl)
DEF_HELPER_3(vpr, void, env, tl, tl)
#endif
