...
static int csr_register_map[] = {
    ...
    CSR_MHCOUNTEREN,
    CSR_ADDR_NDMA_CTRL   ,
    CSR_ADDR_NDMA_STATUS ,
    CSR_ADDR_NDMA_LCADDR ,
    CSR_ADDR_NDMA_RTADDR ,
    CSR_ADDR_NDMA_SIZE   ,
    CSR_ADDR_NDMA_DESTXY ,
    CSR_ROUND_TYPE       ,
    CSR_FADD_SHIFT_NUM   ,
    CSR_FADD_PROT_HIGH   ,
    CSR_FADD_PROT_LOW    ,
    ...
    CSR_FMUL_PROT_HIGH   ,
    CSR_FMUL_PROT_LOW    ,
    CSR_MTX_CLUSTER_START,
    CSR_MTX_CLUSTER_END  ,
    CSR_MTX_REGION_START ,
    CSR_MTX_REGION_END   ,
    CSR_MTX_BLK_SIZE     ,
    CSR_MTX_BLK_NUM      ,
    CSR_MTX_CLS_NUM      ,
    CSR_MTXRW_BLK_STRIDE ,
    CSR_MTXRW_CLS_STRIDE ,
    CSR_MTXRO_BLK_STRIDE ,
    CSR_MTXRO_CLS_STRIDE ,
    CSR_MTX_PAD_TYPE     ,
    CSR_WR_LUT_FIRST     ,
    CSR_WR_LUT_INC       ,
    CSR_FPRINT_ADDR      ,
