 ...
 */
#ifndef __LIBHI_KRNL_PARAM_NETWORK_OBSTACLE_1080P_H__
#define __LIBHI_KRNL_PARAM_NETWORK_OBSTACLE_1080P_H__
...
typedef struct
{
    ...
    paramTableConv1s1_upsmp2x_add_Entry_t           param_blk10[MULTICORE_PARALLEL];
    paramTableConv1s1_upsmp2x_add_Entry_t           param_blk11[MULTICORE_PARALLEL];
    ...
    paramTableConv1s1_conv3s1_conv3s1_Entry_t       param_blk13[MULTICORE_PARALLEL];
    paramTableConv3s1_Entry_t                       param_blk13_1a_c3[MULTICORE_PARALLEL];
    paramTableConv3s1_Entry_t                       param_blk13_1b_r3[MULTICORE_PARALLEL];
    paramTableConv1s1_conv3s1_conv3s1_Entry_t       param_blk14[MULTICORE_PARALLEL];
    paramTableConv3s1_Entry_t                       param_blk14_1a_c3[MULTICORE_PARALLEL];
    paramTableConv3s1_Entry_t                       param_blk14_1b_r3[MULTICORE_PARALLEL];
} paramTable_net_obstacle_1080p_Entry_t;

typedef struct
{
    hirtKernelParamTableBase_t infoBase;
    int count;
    paramTable_net_obstacle_1080p_Entry_t param;
} paramTable_net_obstacle_1080p_t;

#ifdef __cplusplus
}
#endif
#endif /*__LIBHI_KRNL_PARAM_NETWORK_OBSTACLE_1080P_H__*/
